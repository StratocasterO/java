...
public class PasoParametros {
	...
	public static void main(String[] args) {
		...
		System.out.println("El nuevo stringBuffer vale: " + stringBuffer);		// cambia: añade la letra al stringBuffer
		...
		System.out.println("El nuevo String vale: " + string);					// no cambia porque se crea otra dirección de memoria
	}
}
