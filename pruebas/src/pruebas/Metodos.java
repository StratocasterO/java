...
public class Metodos {
	...
	Metodos main = new Metodos();			// instanciamos la clase Main porque no se pueden llamar métodos desde un método static
	...
	public void calculaPerimetroCirca(float radio) {
		...
		System.out.println("El Area del triÃ¡ngulo es: " + r);
	}
